...
reviews.push({
  name: 'Gordon',
  rating: 100,
  feedback: 'My favorite place period.'
});
...
function getReviewByIndex(array, number) {
  console.log(`${array[number].name} gave the restaurant a ${array[number].rating} star review, and their feedback was: ${array[number].feedback}`);
